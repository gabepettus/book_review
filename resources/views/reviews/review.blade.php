                            ...
                            <div class="col-sm-6">
                                <fieldset>
                                    <div class="rating effect">
                                        ...
                                        <input type="radio" id="rating-4" name="rating" value="4" checked="checked"/> <label class="stars" for="rating-4">☆</label>
                                        <input type="radio" id="rating-3" name="rating" value="3" /> <label class="stars" for="rating-3">☆</label>
                                        ...
                                        <input type="radio" id="rating-0" name="rating" value="0" /> <label class="stars" for="rating-0">☆</label> 
                                    </div>
                                </fieldset>
                            </div>
                        </div>
